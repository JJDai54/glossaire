...
switch ($op) {
    case 'load':
        if (\Xmf\Request::hasVar('ok', 'REQUEST') && 1 == $_REQUEST['ok']) {
            ...
            xoops_cp_header();
            xoops_confirm(['ok' => 1, 'op' => 'load'], 'index.php', \sprintf(\constant('_GLOSSAIRE_ADD_SAMPLEDATA_OK')), \constant('_GLOSSAIRE_CONFIRM'), true);
            xoops_cp_footer();
        }
        break;
    case 'save':
...
function loadSampleData()
{
    ...
    \redirect_header('../admin/index.php', 1, \constant('_GLOSSAIRE_SAMPLEDATA_SUCCESS'));
}
...
function saveSampleData()
{
    ...
    \redirect_header('../admin/index.php', 1, \constant('_GLOSSAIRE_SAVE_SAMPLEDATA_SUCCESS'));
}
...
function exportSchema()
{
    ...
    try {
        ...
        //        $migrate = new Glossaire\Migrate($moduleDirName);
        //        $migrate->saveCurrentSchema();
        //
        //        \redirect_header('../admin/index.php', 1, \constant('_GLOSSAIRE_EXPORT_SCHEMA_SUCCESS'));
    } catch (\Exception $e) {
        exit(\constant('_GLOSSAIRE_EXPORT_SCHEMA_ERROR'));
    }
