...
define('_AM_GLOSSAIRE_CLONE_FAIL', "Sorry, we failed to create the new clone. Maybe you need to temporarily set write permissions (CHMOD 777) on the mods folder and try again.");
...
define('_AM_GLOSSAIRE_FILE', "File to import");
