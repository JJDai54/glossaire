...
define('_MI_GLOSSAIRE_ALPHABARRE_MODE_DESC', "<b>No</b>: Displays only the existing letters for the current selection.<br><b>Yes</b>: Displays the complete bar regardless of the selection.");
...
define('_MI_GLOSSAIRE_SHOW_TPL_NAME', "Show template names");
...
define('_MI_GLOSSAIRE_BTN_ACTION_POS_BOTTOM', "At the bottom right of the term sheet");
define('_MI_GLOSSAIRE_BTN_ACTION_POS_TOP', "At the top right of the term");
...
define('_MI_GLOSSAIRE_ALPHABARRE_LETTER_DEFAULT_DESC', "CSS style of default letters.");
define('_MI_GLOSSAIRE_ADMENU1', "Dashboard");
define('_MI_GLOSSAIRE_ALPHABARRE_LETTER_DEFAULT', "Default letter style");
...
define('_MI_GLOSSAIRE_BTN_ACTION_POS_DESC', "Determines for each item the position of the edit/delete/new/top/...");
...
define('_MI_GLOSSAIRE_SEARCH_MODE_GLOBAL', "Global");
...
define('_MI_GLOSSAIRE_IMPORT', "Import");
...
define('_MI_GLOSSAIRE_SEARCH_MODE_DESC', "Module: Use the search function of the module<br>Global: Use the search function of xoops");
define('_MI_GLOSSAIRE_BTN_ACTION_POS_NONE', "No button (use admin for these actions)");
define('_MI_GLOSSAIRE_BREAK_NOTIFICATION', "NOTICES");
...
define('_MI_GLOSSAIRE_SHOW_TPL_NAME_DESC', "Option to use for development, disable it in production");
...
define('_MI_GLOSSAIRE_BTN_ACTION_POS', "Position of action buttons");
define('_MI_GLOSSAIRE_SEARCH_MODE', "Search method");
...
define('_MI_GLOSSAIRE_SHOW_ID', "Show identifiers");
...
define('_MI_GLOSSAIRE_ALPHABARRE_LETTER_EXIST', "Style of existing letters");
define('_MI_GLOSSAIRE_ALPHABARRE_LETTER_NOT_EXIST_DESC', "Style of letters when definitions starting with this do not exist.");
define('_MI_GLOSSAIRE_ALPHABARRE_LETTER_EXIST_DESC', "Style of letters when definitions starting with this exist");
define('_MI_GLOSSAIRE_ALPHABARRE_LETTER_NOT_EXIST', "Style of non-existent letters");
define('_MI_GLOSSAIRE_ALPHABARRE_LETTER_SELECTED', "Style of the selected letter");
define('_MI_GLOSSAIRE_ALPHABARRE_LETTER_SELECTED_DESC', "Style of the selected letter.");
...
define('_MI_GLOSSAIRE_BTN_ACTION_POS_ALL', "Top right and bottom right");
define('_MI_GLOSSAIRE_UPLOAD_GROUPS', "Upload Group Permissions");
define('_MI_GLOSSAIRE_SHOW_ID_DESC', "Used in development mode, preferably leave 'False' in production");
...
define('_MI_GLOSSAIRE_ALPHABARRE', "Letter bar");
define('_MI_GLOSSAIRE_ALPHABARRE_DESC', "List of letters in the selection bar.<br>Special characters:<br><b>\" # \"</b>: selects all terms starting with a number.<br><b>\" * \ \"</b>: adds the option \"Any\"<br><b>\" | \"</b>: adds a line break to separate numbers and letters, for example.");
define('_MI_GLOSSAIRE_ALPHABARRE_MODE', "Show all letters");
