...
define('_MA_GLOSSAIRE_CATEGORIES_DESC', "Glossary categories");
define('_MA_GLOSSAIRE_CATEGORIES_LIST', "Categories");
define('_MA_GLOSSAIRE_CATEGORIES_TITLE', "Categories title");
define('_MA_GLOSSAIRE_CATEGORY_ADD', "New categories");
...
define('_MA_GLOSSAIRE_DESC', "Glossary management module");
...
define('_MA_GLOSSAIRE_ENTRY_NEW', "Add a new term");
define('_MA_GLOSSAIRE_ENTRY_SEARCH', "Chercher");
define('_MA_GLOSSAIRE_ENTRY_SOUMETTRE', "Submit a term");
...
define('_MA_GLOSSAIRE_TOP', "Top");
define('_MA_GLOSSAIRE_CONTACT', "Contact");
define('_MA_GLOSSAIRE_DETAILS', "Show details");
define('_MA_GLOSSAIRE_FILE_LINKED', "Attached file");
define('_MA_GLOSSAIRE_INDEX_LATEST_LIST', "Last Glossaire");
define('_MA_GLOSSAIRE_REFERENCES', "References");
define('_MA_GLOSSAIRE_SEEALSO', "See also");
