 ...
 * @return bool|null
 */
function xoops_module_update_glossaire($module, $prev_version = null)
{
    $ret = null;
    if ($prev_version < 10) {
        $ret = update_glossaire_v10($module);
    }

    $ret = glossaire_check_db($module);

    //check upload directory
	require_once __DIR__ . '/install.php';
    $ret = xoops_module_install_glossaire($module);
 ...
 * @return bool
 */
function update_glossaire_v10($module)
{
    global $xoopsDB;
 ...
 * @return bool
 */
function glossaire_check_db($module)
{
    $ret = true;
    ...
    $table   = $GLOBALS['xoopsDB']->prefix('glossaire_images');
    $field   = 'img_exif';
