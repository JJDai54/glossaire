    ...
    public function __construct()
{
        ...
        $this->initVar('cat_date_format', \XOBJ_DTYPE_TXTBOX);
    ...
    public function getFormCategoriesCss($action = false)
    {
        ...
        $title = sprintf("<span style='font-size:1.5em;'>%s</span><br>%s", $this->getVar('cat_name'), \_AM_GLOSSAIRE_CATEGORY_EDIT_CSS);
...
//                          $optionsSeparator = ";")
        ...
        $form->addElement($inpShowBin);        
                ...
                // Form date_format 
        $inpDateFormat = new \XoopsFormText(\_AM_GLOSSAIRE_DATE_FORMAT, 'cat_date_format', 50, 50, $this->getVar('cat_date_format'));
        $inpDateFormat->setDescription(_AM_GLOSSAIRE_DATE_FORMAT_DESC);
        $form->addElement($inpDateFormat);

//========================================================
        $form->insertBreak(sprintf($styleBreakLine, _AM_GLOSSAIRE_ENT_HEADER));
        //========================================================
