    ...
    <table class="table table-bordered" name="entries_list" id = "entries_list">
        <thead>
            <tr class="head">
                ...
                <th class="center"><{$smarty.const._AM_GLOSSAIRE_ENTRY_TERM}> / <{$smarty.const._AM_GLOSSAIRE_ENTRY_SHORTDEF}></th>
                ...
                <th class="center"><{$smarty.const._AM_GLOSSAIRE_ENTRY_DATE_CREATION}> / <{$smarty.const._AM_GLOSSAIRE_ENTRY_DATE_UPDATE}></th>
        ...
        <tbody>
            ...
            <tr class="<{cycle values='odd, even'}>">
                ...
                <td class="center"><{$entry.date_creation}><br><{$entry.date_update}></td>
